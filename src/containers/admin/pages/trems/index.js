...
import { addTremsCMSDataAction } from "./actions";
import "./style.scss";
...
const EditTermsCMS = (props) => {
  ...
  const initialState = {
    name: props.terms?.name ? props.terms?.name : "",
    url: props.terms?.url ? props.terms?.url : "/terms-of-service",
    excerpt: props.terms?.excerpt ? props.terms?.excerpt : "",
    thumbnail: props.terms?.thumbnail ? props.terms?.thumbnail : "",
    terms_title: props.terms?.terms_title ? props.terms?.terms_title : "",
    contents: props.terms?.contents ? props.terms?.contents : "",
  };
  ...
  const handleSubmit = (values) => {
    ...
    props.addTremsCMSDataAction(form_data, setGeneralEdit);
    setHeroEdit(false);
  };
  ...
  useEffect(() => {
    setKeywords(props.terms?.keyword ? props.terms?.keyword : []);
  }, [props.terms?.keyword]);
          ...
          <div className="row">
            <div className="col-lg-8 offset-lg-2">
              <div className="d-flex flex-wrap align-items-center justify-content-between titleBoxWrap mb-25">
                <h2 className="adminSectionTitle">Terms of Service Page</h2>
                <span className="edit">
...
export default connect(mapStateToProps, {
  addTremsCMSDataAction,
  getTermsDetailsAction,
  uploadFileAction,
})(withRouter(EditTermsCMS));
