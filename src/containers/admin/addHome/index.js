...
import {addNewResourceAction, getCategoriesListAction,} from "../dashboard/actions";
import "./style.scss";
import SelectTodo from "./todo";

pdfjs.GlobalWorkerOptions.workerSrc = `//cdnjs.cloudflare.com/ajax/libs/pdf.js/${pdfjs.version}/pdf.worker.js`;
const validationSchema = Yup.object({
  categories: Yup.string().required("categories can not be empty"),
...
const AddHome = (props) => {
  ...
  const saveDraftHandler = (values, dirty) => {
    ...
    if (dirty) props.addNewResourceAction(form_data, props.history);
  };

  const publishLaterHandler = (dirty) => {
    if (dirty) setPublishDateModal(true);
  };
                    ...
                    <Form className="usefulFeatureForm">
                      ...
                      <div className="usefulFeatureFormBG mb-50">
                        ...
                        >
                          ...
                          <option value="best-practices">Audio Program</option>
                        </Field>
                        {/* <Field
                          label="Categories"
                          id="categories"
                        ...
                        <div className="blackListModalWrap">
                          ...
                          <ul className="modalBtns">
                            <li>
                              <button
                                type="submit"
                                onClick={() => publishDateSubmitOption(values)}
                                className="success"
                              >
                      ...
                      <ul className="submitButtons">
                        <li>
                          <button
                            className="drafts"
                            type="submit"
                            onClick={() => saveDraftHandler(values, dirty)}
                          >
                            Save to Drafts
                          </button>
                        </li>
                        ...
                        <li>
                          <button
                            ...
                            type="submit"
                            onClick={() => publishLaterHandler(dirty)}
                          >
                            Publish Later
                          </button>
                        </li>
