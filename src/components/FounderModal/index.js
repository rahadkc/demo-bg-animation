              ...
              <ul className="modalBtns">
                <li>
                  {props.submitBtn ? (
                    <button
                      type="submit"
                      onClick={() => props.submit(props.values)}
                      className="success"
                    >
                      Upgrade to Founder <img src={submit} alt="submit" />
                    </button>
                  ) : (
                ...
                <li>
                  <button
                    ...
                    className="error"
                  >
                    Maybe Later <img src={cancel} alt="submit" />
                  </button>
                </li>
              </ul>
            </div>
